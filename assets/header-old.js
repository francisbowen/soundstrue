...
$(document).ready(function(e) {
  ...
  $(".equal-buy-btn").on('click', function() {
    $('.equal-buy-popup').addClass('active');
  });
...
$(document).ready(function() {
  let mylist = $('.author-blogs .logo-bar');
  ...
  if(ascending == null || ascending) {
    ...
    $('.sort-by-swicher').text('Set Descending Direction');
  } else {
    $('.sort-by-swicher').addClass('sort-by--desc');
    $('.sort-by-swicher').text('Set Ascending Direction');
  }
  ...
  $('.sort-by-swicher').on('click', function () {
    ...
    $(this).text(($(this).hasClass('sort-by--asc')) ? 'Set Descending Direction' : 'Set Ascending Direction');
  });
});
...
$(document).ready(function() {
  let windowSizeCheck = function() {
    ...
    if($(window).width() < 753) {
      ...
      $('.rte .prod_para').css('padding-left', 0);
      $('.rte .prod_para').css('margin-left', 0);
      $('.social-sharing').css('margin-left', 0);
    } else { // Desktop
      ...
      $('.rte .prod_para').css('padding-left', 50);
      $('.rte .prod_para').each(function(index, element) {
        if($(this).position().left == imageDiv.position().left) {
          $(this).css('margin-left', imageDivWidth);
        }
      });

      $('.social-sharing').css('margin-left', marginLeft);
    }
  }
